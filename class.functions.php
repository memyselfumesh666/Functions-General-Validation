...
class functions
{
	...
	public function pre($filename_prefix = "No value passed!! ", $exit = false)
	{
		echo "<pre>";
	...
	public static function get_format_date($datetime, $format = 'd-M-Y')
	{
		$date	= '';
		$time	= '';
		$month	= 0;
	...
	public static function  noscript_message($redirect = true, $time = 1)
	{
	...
	*/
	...
	public static function date_formats($date)
	{
		$today	= "";
		$year	= 0;
		$mon	= 0;
	...
	public static function paginate($allNum, $show = 0, $param = '', $user_type = 'ADMIN')
	{
	...
	public function paginate_amwell_voice($allNum, $show = 0, $param = '', $user_type = 'CLIENT')
	{
		$database = new database();
	...
	*/
	...
	function upload_file($file_object, $upload_path, $allowed_extensions = '', $max_upload_limit = 1024, $create_unique_name = true, $filename_prefix = '')
	{
		/*************************************************
		...
		*************************************************/
		...
		else
		{
			...
			//functions::pre($file_object);
			//print $file_full_path;
			//print '<br />' . $file_object['tmp_name'];exit;
		}
